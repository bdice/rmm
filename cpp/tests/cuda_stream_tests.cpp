...
TEST_F(CudaStreamTest, IsDefaultStream)
{
  ...
  EXPECT_EQ(rmm::cuda_stream_view{rmm::cuda_stream_default}.is_default(),
            rmm::detail::is_default_stream(rmm::cuda_stream_default));
  EXPECT_EQ(rmm::cuda_stream_view{rmm::cuda_stream_legacy}.is_default(),
            rmm::detail::is_default_stream(rmm::cuda_stream_legacy));
  EXPECT_EQ(rmm::cuda_stream_view{rmm::cuda_stream_per_thread}.is_default(),
