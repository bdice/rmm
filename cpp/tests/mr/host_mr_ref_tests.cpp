...
// UnsupportedAlignmentTest removed: alignment validation was previously provided by the
// device_memory_resource base class. The CCCL resource concept does not mandate alignment
// validation.
